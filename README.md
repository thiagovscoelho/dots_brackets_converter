...
Incidentally, formulas from the first 51 propositions of Frege’s *Begriffsschrift* in more modern notations provide interesting test cases of dots–brackets conversion, since they are historically significant propositional tautologies that require a lot of bracketing, and they have been rendered in both bracket notation and dot notation: [I.M. Bocheński](https://archive.org/details/historyofformall00boch) (§43.22, pp. 338-340) translated the first 57 of Frege’s propositions into Russellian dot notation, and [Richard L. Mendelsohn](https://archive.org/details/philosophyofgott0000mend) (appendices A and B) translated the first 68 propositions as well as their proofs into fully bracketed notation. (I focused on the first 51 propositions because from proposition 52 onwards of the *Begriffsschrift*, Frege begins to use functional expressions, which makes his formulas much less bracket-heavy, and no longer adequately handled by the program in the form in which they were written by Bocheński and Mendelsohn, although they can be easily correctly bracketed/dotted by the program if you simply change every “f(x)” into “fx”, etc. See below for supported expressions.)
